...
@Component({
  selector: "[data-cmp-fixed-photo-block]",
  templateUrl: "./fixed-photo-story-block.component.html",
  styleUrls: ["./fixed-photo-story-block.component.scss"]
})
export class FixedPhotoStoryBlockComponent  {
